...
class __$$ImageSelectedImplCopyWithImpl<T, $Res>
    extends _$UpdateProfileStateCopyWithImpl<T, $Res, _$ImageSelectedImpl<T>>
...
class _$ImageSelectedImpl<T> implements ImageSelected<T> {
  ...
  @override
  String toString() {
    return 'UpdateProfileState<$T>.imageSelected(image: $image)';
  }
...
abstract class ImageSelected<T> implements UpdateProfileState<T> {
